...
<?php 
    ...
    <form action="input_addtrees.php" method="POST" enctype="multipart/form-data">
		...
		<table width="1000" cellspacing="0" cellpadding="1" border="0" align="center">
			...
			<tr>
				<th style="width:400px;height:50px" align="left"> </th><td>Đặc điểm </td>
				<td></td>
				<!-- <td><input type="text" name="Dacdiem" style="width: 300px;"><br> -->
				<td><textarea rows="5" cols="20" placeholder="Đây là vùng nhập text" class="input" name="Dacdiem" style="width: 700px;height: 100px;"></textarea><br>
            </td></tr>
			<tr>
			<th style="width: 700px;height:50px" align="left"><td> Loại cây </td></th>
			<td></td>
			<td>
            ...
            <tr>
				...
				<td><textarea rows="5" cols="20" placeholder="Đây là vùng nhập text" class="input" name="Cachchamsoc" style="width: 700px;height: 100px;"></textarea><br>
            </td></tr>
			<tr>
            ...
            <tr>
				...
				<td></td>
				<td><textarea rows="5" cols="20" placeholder="Đây là vùng nhập text" class="input" name="Motacay" style="width: 700px;height: 100px;"></textarea><br>
			</td>
			</tr>
			<tr>
				<td>
